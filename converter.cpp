...
int main()
{
	const int device_count = (sizeof(gChipInfo) / sizeof(gChipInfo[0])) + (sizeof(gChipInfo_STM32_6_2_4) / sizeof(gChipInfo_STM32_6_2_4[0])) +(sizeof(gChipInfo_STM32_4_6_7) / sizeof(gChipInfo_STM32_4_6_7[0])) + (sizeof(gChipInfo_csky) / sizeof(gChipInfo_csky[0])) + (sizeof(gChipInfo_AMLOGIC) / sizeof(gChipInfo_AMLOGIC[0]));
